...
void calibrate_sensors() {
  ...
  int left[5] = {9, 10, 11, 12, 13};
  int midF = 5;
  int midB = 6;
  int right[5] = {8, 7, 4, 3, 2};
...
*/
  ...
  stateCol = accel_t_gyro.value.x_accel/1000;
  stateRow = accel_t_gyro.value.y_accel/1000;

/*
  Serial.print(stateCol, DEC);
  Serial.print(F(",      "));
  Serial.println(stateRow, DEC);
*/

// Lateral acceleration

//  Serial.print(stateRow);
//  Serial.print("   ");
//  Serial.print(stateRow);
  ...
  if(stateRow > 13.5 ) {
    ...
    digitalWrite(left[4], HIGH);
  }
  else if(stateRow > 10.5) {
    digitalWrite(left[0], HIGH);
    digitalWrite(left[1], HIGH);
    digitalWrite(left[2], HIGH);
    digitalWrite(left[3], HIGH);
    digitalWrite(left[4], LOW);
  }
  else if(stateRow > 7.5) {
    digitalWrite(left[0], HIGH);
    digitalWrite(left[1], HIGH);
    digitalWrite(left[2], HIGH);
    digitalWrite(left[3], LOW);
    digitalWrite(left[4], LOW);
  }
  else if(stateRow > 4.5) {
    digitalWrite(left[0], HIGH);
    digitalWrite(left[1], HIGH);
    ...
    digitalWrite(right[3], LOW);
    digitalWrite(right[4], LOW);
  }
  else if(stateRow > -4.5) {
  ...
  else if(stateRow > -13.5) {
    digitalWrite(right[0], HIGH);
    digitalWrite(right[1], HIGH);
    digitalWrite(right[2], HIGH);
    digitalWrite(right[3], HIGH);
    digitalWrite(right[4], LOW);
  }  
  else if(stateRow > -16.5) {
    digitalWrite(right[0], HIGH);
    digitalWrite(right[1], HIGH);
    digitalWrite(right[2], HIGH);
    digitalWrite(right[3], HIGH);
    digitalWrite(right[4], HIGH);
  }
    delay(50);
    digitalWrite(left[0], LOW);
    digitalWrite(left[1], LOW);
...
//  Serial.print("   ");
//  Serial.print(stateCol);
//  Serial.print("   ");
  
  stateCol = map(stateCol, -18, 18, 0, 255);
  constrain(stateCol, 0, 255);
  
//  Serial.println(stateCol);

  analogWrite(midF, 255-stateCol);
  analogWrite(midB, stateCol);
